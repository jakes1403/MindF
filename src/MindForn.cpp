...
// Old but currently only version that works - Compiles bf string directly to a string containing C++ but with no optimizations (should be fine tbh the C++ compiler is really good) - optimizations are really just good to reduce file size
